#Tutorial Install OCS Panel (SSH Reseller Panel)
...
#MysQL root
mysql -u root -p && CREATE DATABASE IF NOT EXISTS OCSPANEL;EXIT; 


#install git repository for OCS PANEL
apt-get -y install git

#Configure VPS master folder
